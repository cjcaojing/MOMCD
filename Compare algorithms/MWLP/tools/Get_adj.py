...
#    ij_participate_motif_number_list=four_two
...
G = G.to_undirected()
#生成加权矩阵
Gi=ig.Graph.Read_Edgelist(r"../data/"+network_name+".txt")
Gi=Gi.subgraph(map(int,G.nodes()))          
Gi=Gi.as_undirected()

benchmark=open("../data/"+network_name+".txt")
...
# ij_participate_motif_number_list = motif_func_list[M](Gi,edge_all)
